...
Ferramentas utilizadas:VS Code com e as seguintes dependencias o correto funcionamento do codigo: pandas, numpy, matplotlib e seaborn, notebook jupyter e ipykernel.
...
Nota 1: Utilizando o codigo modelo, foi necessario corrigir a identação e chamar a função df_bruto para impressao.

Etapa 3 - Limpeza e tratamento dos dados
Bloco de códigos para as seguintes funções:
...
Nota 2: Foi necessário chamar a função para exibir o relatório. Também, anulou-se a função import re, sem uso neste bloco, e geramos nova inspeção do relatório, agora limpo.
...
Nota 3: Necessário acrescentar o comando de execução da função ao final, como no bloco anterior

Etapa 5 - Calculo de métricas agrupadas
Apresentamos as informações a seguir:
-Receita total e quantidade vendida por mês;
-Receita total por produto (top 5);
-Receita total por categoria;
-Receita total por região.

Nota 4: comando de execução incluído
...
Nota 5: Necessário incluir o comando que chama e executa a função.
...
Nota 6: Inclusao da linha de codigo que chama e executa a função.
...
Criamos uma classe que encapsule parte do pipeline e contém o contrutor (__init__), atributos e métodos que usem self.

Nota 7: Necessário criar uma instance e incluir comando para rodar o codigo passo a passo e exibir o relatório.
...
Nota 8: Necessário criar uma instance e incluir metodos de projeção.
...
Nota 9: Necessario incluir a linha de codigo de execução para exibir o resultados e o arquivo Json
